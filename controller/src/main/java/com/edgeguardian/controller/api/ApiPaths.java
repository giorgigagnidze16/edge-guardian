...
public final class ApiPaths {
    ...
    public static final String AGENT_LATEST_VERSION_PATH = "/latest-version";
    ...
    public static final String AGENT_LATEST_VERSION = AGENT_BASE + AGENT_LATEST_VERSION_PATH;
